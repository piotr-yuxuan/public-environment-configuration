...
- [[Testing changes][Testing changes]]
  ...
  - [[Shell script unit tests (bats)][Shell script unit tests (bats)]]
...
The =tests/= directory contains [[https://bats-core.readthedocs.io/][bats-core]] test suites that cover the
...
The suite also runs automatically in CI on every push and pull request
